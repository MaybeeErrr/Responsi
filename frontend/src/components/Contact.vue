...
<p class="text-xl text-gray-300 mb-8">Siapa tau ada yang ingin ditanyakan.</p>
<a href="erioktafianto11@gmail.com" class="bg-blue-600 text-white font-bold py-3 px-6
...
<p class="text-gray-500">&copy; {{ new Date().getFullYear() }} Eri Oktafianto. Dibuat dengan VScode
</p>
</div>
</footer>
</template>
