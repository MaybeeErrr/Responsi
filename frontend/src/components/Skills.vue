...
const skills = ref([
  { name: 'HTML5', level: 'Menengah' },
  { name: 'CSS3 & Tailwind', level: 'Menengah' },
  ...
  <section id="skill" class="py-20 bg-gray-50 sm:py-24">
    <div class="container mx-auto px-6">
      ...
      <p class="text-center text-lg text-gray-600 max-w-2xl mx-auto -mt-4 mb-12">
        Berikut adalah beberapa teknologi dan keahlian yang saya kuasai dan sedang saya coba kembangkan.
      </p>
