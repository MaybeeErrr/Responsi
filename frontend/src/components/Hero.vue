...
200ms;">
Halo, Saya <span class="text-blue-600">Eri</span>
</h1>
<p class="text-xl text-gray-600 mb-8 animate-slide-in-left" style="animation-delay: 400ms;">
Mahasiswa Teknik Informatika yang mecoba keluar dari zona nyaman untuk mencari kehidupan yang lebih baik kedepannya.
</p>
